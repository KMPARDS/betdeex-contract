...
contract Bet is betInterface{
    ...
    function initialize(address _owner1, string memory _description, uint8 _category, uint8 _subCategory, uint256 _minimumBetInExaEs, uint256 _prizePercentPerThousand, bool _isDrawPossible, uint256 _pauseTimestamp) public {
        _owner = _owner1;
    ...
    function enterBet(uint8 _choice, uint256 _betTokensInExaEs) public onlyKYC payable{
        ...
        //dayswappersContract.payToTree{value: _treeAmount}(msg.sender,[uint256(50), uint256(0), uint256(50)]);
        //dayswappersContract.payToIntroducer{value: _introducerAmount}(msg.sender,[uint256(50), uint256(0), uint256(50)]);
    ...
    function withdrawPrize(address payable _bettorAddress) public onlyKycApproved payable{
